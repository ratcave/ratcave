...
void main()
  {
	...
	vVertex = (model_matrix * vec4(vertexPosition, 1.0)).xyz;
	...
	eyeVec = vVertex - playerPos;
  	...
  	ShadowCoord = (texture_bias * shadow_projection_matrix * shadow_view_matrix * model_matrix * vec4(vertexPosition, 1.0));
